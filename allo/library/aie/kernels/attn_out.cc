...
extern "C" {
void scale_attn_output(bfloat16 tensor_in[64][64], bfloat16 sum_exp[64],
                       bfloat16 tensor_out[64][64]) {
  row_scale<bfloat16, bfloat16, 64, 64>(&tensor_in[0][0], sum_exp, &tensor_out[0][0]);
}

void rescale_attn_output(bfloat16 tensor_in[64][64], bfloat16 scale_exp[64],
                       bfloat16 tensor_out[64][64]) {
  row_rescale<bfloat16, bfloat16, 64, 64>(&tensor_in[0][0], scale_exp, &tensor_out[0][0]);
}
}
