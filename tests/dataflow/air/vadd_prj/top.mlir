module {
  func.func @vector_add(%arg0: memref<1024xf32>, %arg1: memref<1024xf32>, %arg2: memref<1024xf32>) {
    ...
    air.herd @herd_0  tile (%arg3, %arg4) in (%arg5=%c1, %arg6=%c1_0) args(%arg7=%arg0, %arg8=%arg1, %arg9=%arg2) : memref<1024xf32>, memref<1024xf32>, memref<1024xf32> {
      ...
      air.dma_memcpy_nd (%alloc[] [] [], %arg7[%c0] [%c1024_4] [%c1_5]) : (memref<1024xf32, 2 : i32>, memref<1024xf32>)
      %c1024_6 = arith.constant 1024 : index
      %c1_7 = arith.constant 1 : index
      air.dma_memcpy_nd (%alloc_1[] [] [], %arg8[%c0] [%c1024_6] [%c1_7]) : (memref<1024xf32, 2 : i32>, memref<1024xf32>)
      ...
      air.dma_memcpy_nd (%arg9[%c0] [%c1024_11] [%c1_12], %alloc_2[] [] []) : (memref<1024xf32>, memref<1024xf32, 2 : i32>)
