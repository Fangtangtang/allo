module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_4(%tile_0_4, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    ...
    aie.objectfifo @fifo_6(%mem_tile_3_1 dimensionsToStream [<size = 16, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>], {%tile_0_3, %tile_0_5}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    aie.objectfifo @fifo_7(%shim_noc_tile_3_0, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<1x1x64x64xbf16>> 
    aie.objectfifo @fifo_8(%tile_0_3, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    ...
    %buffer_0_4_1 = aie.buffer(%tile_0_4) : memref<4096xbf16> 
    %buffer_0_3 = aie.buffer(%tile_0_3) : memref<64x64xbf16> 
    %buffer_0_3_2 = aie.buffer(%tile_0_3) : memref<4096xbf16> 
    %buffer_1_2 = aie.buffer(%tile_0_5) : memref<64x64xbf16> 
    %buffer_1_2_3 = aie.buffer(%tile_0_5) : memref<4096xbf16> 
    ...
    %core_0_4 = aie.core(%tile_0_4) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %2 = aie.objectfifo.acquire @fifo_0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        func.call @matmul_bf16_bf16(%3, %buffer_0_4, %1) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
        aie.objectfifo.release @fifo_0(Consume, 1)
    ...
    %core_1_2 = aie.core(%tile_0_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %2 = aie.objectfifo.acquire @fifo_6(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        func.call @matmul_bf16_bf16(%3, %buffer_1_2, %1) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
        aie.objectfifo.release @fifo_6(Consume, 1)
    ...
    aiex.runtime_sequence(%arg0: memref<4096xbf16>, %arg1: memref<131072xbf16>, %arg2: memref<4096xbf16>, %arg3: memref<131072xbf16>) {
      ...
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][16, 1, 64, 64][0, 0, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_1} : memref<4096xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][16, 1, 64, 64][128, 64, 2048, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_3} : memref<131072xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][16, 1, 64, 64][128, 64, 2048, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_5} : memref<131072xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][16, 1, 64, 64][0, 0, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_7} : memref<4096xbf16>
      aiex.npu.dma_memcpy_nd(%arg3[0, 0, 0, 0][16, 1, 64, 64][128, 64, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_9} : memref<131072xbf16>
      aiex.npu.dma_memcpy_nd(%arg3[0, 0, 0, 64][16, 1, 64, 64][128, 64, 2048, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_11} : memref<131072xbf16>
