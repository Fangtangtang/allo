module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_0(%mem_tile_0_1 dimensionsToStream [<size = 16, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>], {%tile_0_3, %tile_0_4, %tile_0_2, %tile_0_5}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    ...
    aie.objectfifo @fifo_8(%tile_0_5, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    ...
    %core_0_5 = aie.core(%tile_0_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %2 = aie.objectfifo.acquire @fifo_0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        func.call @matmul_bf16_bf16(%3, %buffer_0_5, %1) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
        aie.objectfifo.release @fifo_0(Consume, 1)
    ...
    aiex.runtime_sequence(%arg0: memref<4096xbf16>, %arg1: memref<262144xbf16>) {
      ...
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][16, 1, 64, 64][256, 64, 4096, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_3} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][16, 1, 64, 64][256, 64, 4096, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_5} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 128][16, 1, 64, 64][256, 64, 4096, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_7} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 192][16, 1, 64, 64][256, 64, 4096, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_9} : memref<262144xbf16>
