module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_0(%mem_tile_0_1 dimensionsToStream [<size = 16, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>], {%tile_0_2, %tile_0_4}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    aie.objectfifo @fifo_1(%shim_noc_tile_0_0, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<1x1x64x64xbf16>> 
    aie.objectfifo @fifo_2(%mem_tile_1_1 dimensionsToStream [<size = 8, stride = 512>, <size = 16, stride = 4>, <size = 8, stride = 64>, <size = 4, stride = 1>], {%tile_0_2, %tile_0_4}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    ...
    aie.objectfifo @fifo_6(%tile_0_4, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    ...
    aie.objectfifo @fifo_8(%mem_tile_0_1 dimensionsToStream [<size = 16, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>], {%tile_0_3, %tile_0_5}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    aie.objectfifo @fifo_9(%shim_noc_tile_0_0, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<1x1x64x64xbf16>> 
    aie.objectfifo @fifo_10(%mem_tile_0_1 dimensionsToStream [<size = 8, stride = 512>, <size = 16, stride = 4>, <size = 8, stride = 64>, <size = 4, stride = 1>], {%tile_0_5, %tile_0_3}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    aie.objectfifo @fifo_11(%shim_noc_tile_1_0, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<1x1x64x64xbf16>> 
    aie.objectfifo @fifo_12(%tile_0_3, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    aie.objectfifo @fifo_13(%mem_tile_0_1 dimensionsToStream [<size = 16, stride = 256>, <size = 4, stride = 4>, <size = 16, stride = 16>, <size = 4, stride = 1>], {%shim_noc_tile_0_0}, 2 : i32) : !aie.objectfifo<memref<1x1x64x64xbf16>> 
    aie.objectfifo @fifo_14(%tile_0_5, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    aie.objectfifo @fifo_15(%mem_tile_1_1 dimensionsToStream [<size = 16, stride = 256>, <size = 4, stride = 4>, <size = 16, stride = 16>, <size = 4, stride = 1>], {%shim_noc_tile_0_0}, 2 : i32) : !aie.objectfifo<memref<1x1x64x64xbf16>> 
    ...
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        func.call @fill_zeros_bf16_64_64_vector(%1) {lib = "fill_zeros_bf16_64_64_vector"} : (memref<64x64xbf16>) -> ()
        %2 = aie.objectfifo.acquire @fifo_8(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
    ...
    aiex.runtime_sequence(%arg0: memref<8192xbf16>, %arg1: memref<262144xbf16>, %arg2: memref<8192xbf16>, %arg3: memref<262144xbf16>) {
      ...
      aiex.npu.address_patch {addr = 67228132 : ui32, arg_idx = 4 : i32, arg_plus = 0 : i32}
      ...
      aiex.npu.address_patch {addr = 67228100 : ui32, arg_idx = 4 : i32, arg_plus = 0 : i32}
      ...
      aiex.npu.address_patch {addr = 67228068 : ui32, arg_idx = 4 : i32, arg_plus = 0 : i32}
      ...
      aiex.npu.address_patch {addr = 67228036 : ui32, arg_idx = 4 : i32, arg_plus = 0 : i32}
      ...
      aiex.npu.address_patch {addr = 67228004 : ui32, arg_idx = 4 : i32, arg_plus = 0 : i32}
      ...
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][32, 1, 64, 64][0, 0, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_1} : memref<8192xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][32, 1, 64, 64][0, 0, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_3} : memref<8192xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][32, 1, 64, 64][128, 64, 4096, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_5} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][32, 1, 64, 64][128, 64, 4096, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_7} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 4096][32, 1, 64, 64][0, 0, 64, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_9} : memref<8192xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 4096][32, 1, 64, 64][0, 0, 64, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_11} : memref<8192xbf16>
      aiex.npu.dma_memcpy_nd(%arg3[0, 0, 0, 0][32, 1, 64, 64][128, 64, 4096, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_13} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg3[0, 0, 0, 64][32, 1, 64, 64][128, 64, 4096, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_15} : memref<262144xbf16>
