module {
  aie.device(npu1_4col) {
    ...
    %fifo_2_buff_0 = aie.buffer(%tile_0_2) : memref<16xi32> 
    %fifo_2_buff_1 = aie.buffer(%tile_0_2) : memref<16xi32> 
    %fifo_2_prod_lock_0 = aie.lock(%tile_0_2, 0) {init = 2 : i32, sym_name = "fifo_2_prod_lock_0"}
    %fifo_2_cons_lock_0 = aie.lock(%tile_0_2, 1) {init = 0 : i32, sym_name = "fifo_2_cons_lock_0"}
    ...
    %pipe_buff_0 = aie.buffer(%tile_0_3) : memref<16xi32> 
    %pipe_buff_1 = aie.buffer(%tile_0_3) : memref<16xi32> 
    %pipe_prod_lock_0 = aie.lock(%tile_0_3, 0) {init = 2 : i32, sym_name = "pipe_prod_lock_0"}
    ...
    %_anonymous1 = aie.buffer(%tile_0_2) : memref<i32> 
    %_anonymous2 = aie.buffer(%tile_0_2) : memref<16xi32> 
    ...
    ^bb2:  // pred: ^bb1
      ...
      aie.use_lock(%pipe_prod_lock_0, AcquireGreaterEqual, 1)
      memref.copy %fifo_0_cons_buff_0, %pipe_buff_0 : memref<16xi32> to memref<16xi32>
      aie.use_lock(%pipe_cons_lock_0, Release, 1)
      aie.use_lock(%fifo_0_cons_prod_lock_0, Release, 1)
      aie.use_lock(%fifo_0_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%pipe_prod_lock_0, AcquireGreaterEqual, 1)
      memref.copy %fifo_0_cons_buff_1, %pipe_buff_1 : memref<16xi32> to memref<16xi32>
      aie.use_lock(%pipe_cons_lock_0, Release, 1)
      aie.use_lock(%fifo_0_cons_prod_lock_0, Release, 1)
    ...
    ^bb2:  // pred: ^bb1
      ...
      memref.store %c1_i32, %_anonymous1[] : memref<i32>
    ...
    ^bb4:  // pred: ^bb3
      %4 = memref.load %_anonymous1[] : memref<i32>
      memref.store %4, %_anonymous2[%2] : memref<16xi32>
      %5 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%5 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%fifo_2_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @add_i32_vector(%pipe_buff_0, %_anonymous2, %fifo_2_buff_0) {lib = "add_i32_vector"} : (memref<16xi32>, memref<16xi32>, memref<16xi32>) -> ()
      aie.use_lock(%pipe_prod_lock_0, Release, 1)
    ...
    ^bb7:  // pred: ^bb6
      %8 = memref.load %_anonymous1[] : memref<i32>
      memref.store %8, %_anonymous2[%6] : memref<16xi32>
      %9 = arith.addi %6, %c1_4 : index
      cf.br ^bb6(%9 : index)
    ^bb8:  // pred: ^bb6
      aie.use_lock(%fifo_2_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @add_i32_vector(%pipe_buff_1, %_anonymous2, %fifo_2_buff_1) {lib = "add_i32_vector"} : (memref<16xi32>, memref<16xi32>, memref<16xi32>) -> ()
      aie.use_lock(%pipe_prod_lock_0, Release, 1)
      aie.use_lock(%fifo_2_cons_lock_0, Release, 1)
    ...
    ^bb11:  // pred: ^bb10
      %13 = memref.load %_anonymous1[] : memref<i32>
      memref.store %13, %_anonymous2[%11] : memref<16xi32>
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%fifo_2_buff_0 : memref<16xi32>, 0, 16) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%fifo_2_prod_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%fifo_2_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%fifo_2_buff_1 : memref<16xi32>, 0, 16) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%fifo_2_prod_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      aie.end
