module {
  aie.device(npu1_4col) {
    ...
    %pipe_B_0_buff_0 = aie.buffer(%tile_0_3) : memref<32x32xbf16> 
    %pipe_B_0_buff_1 = aie.buffer(%tile_0_3) : memref<32x32xbf16> 
    %pipe_B_0_prod_lock_0 = aie.lock(%tile_0_3, 2) {init = 2 : i32, sym_name = "pipe_B_0_prod_lock_0"}
    %pipe_B_0_cons_lock_0 = aie.lock(%tile_0_3, 3) {init = 0 : i32, sym_name = "pipe_B_0_cons_lock_0"}
    %pipe_A_0_buff_0 = aie.buffer(%tile_0_3) : memref<32x32xbf16> 
    %pipe_A_0_buff_1 = aie.buffer(%tile_0_3) : memref<32x32xbf16> 
    %pipe_A_0_prod_lock_0 = aie.lock(%tile_0_3, 0) {init = 2 : i32, sym_name = "pipe_A_0_prod_lock_0"}
    ...
    ^bb2:  // pred: ^bb1
      ...
      aie.use_lock(%pipe_A_0_prod_lock_0, AcquireGreaterEqual, 1)
      memref.copy %fifo_0_cons_buff_0, %pipe_A_0_buff_0 : memref<32x32xbf16> to memref<32x32xbf16>
      aie.use_lock(%pipe_A_0_cons_lock_0, Release, 1)
      aie.use_lock(%pipe_B_0_prod_lock_0, AcquireGreaterEqual, 1)
      memref.copy %fifo_2_cons_buff_0, %pipe_B_0_buff_0 : memref<32x32xbf16> to memref<32x32xbf16>
      ...
      aie.use_lock(%pipe_A_0_prod_lock_0, AcquireGreaterEqual, 1)
      memref.copy %fifo_0_cons_buff_1, %pipe_A_0_buff_1 : memref<32x32xbf16> to memref<32x32xbf16>
      aie.use_lock(%pipe_A_0_cons_lock_0, Release, 1)
      aie.use_lock(%pipe_B_0_prod_lock_0, AcquireGreaterEqual, 1)
      memref.copy %fifo_2_cons_buff_1, %pipe_B_0_buff_1 : memref<32x32xbf16> to memref<32x32xbf16>
      aie.use_lock(%pipe_B_0_cons_lock_0, Release, 1)
      aie.use_lock(%fifo_0_cons_prod_lock_0, Release, 1)
      aie.use_lock(%fifo_2_cons_prod_lock_0, Release, 1)
      aie.use_lock(%fifo_4_cons_lock_0, Release, 1)
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @matmul_bf16_bf16(%pipe_A_0_buff_0, %pipe_B_0_buff_0, %fifo_6_buff_0) {lib = "matmul_bf16_bf16"} : (memref<32x32xbf16>, memref<32x32xbf16>, memref<32x32xbf16>) -> ()
      aie.use_lock(%pipe_A_0_prod_lock_0, Release, 1)
      aie.use_lock(%pipe_B_0_prod_lock_0, Release, 1)
      ...
      func.call @matmul_bf16_bf16(%pipe_A_0_buff_1, %pipe_B_0_buff_1, %fifo_6_buff_1) {lib = "matmul_bf16_bf16"} : (memref<32x32xbf16>, memref<32x32xbf16>, memref<32x32xbf16>) -> ()
      aie.use_lock(%pipe_A_0_prod_lock_0, Release, 1)
      aie.use_lock(%pipe_B_0_prod_lock_0, Release, 1)
      aie.use_lock(%fifo_6_cons_lock_0, Release, 1)
      %2 = arith.addi %0, %c2 : index
