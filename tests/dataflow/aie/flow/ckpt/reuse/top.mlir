module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_2(%tile_0_3, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<16xi32>> 
    aie.objectfifo @fifo_3(%mem_tile_1_1, {%shim_noc_tile_1_0}, 2 : i32) : !aie.objectfifo<memref<1x1x1x16xi32>> 
    aie.objectfifo @fifo_4(%tile_0_2, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<16xi32>> 
    aie.objectfifo @fifo_5(%mem_tile_2_1, {%shim_noc_tile_2_0}, 2 : i32) : !aie.objectfifo<memref<1x1x1x16xi32>> 
    aie.objectfifo.link [@fifo_1] -> [@fifo_0]([] [])
    aie.objectfifo.link [@fifo_2] -> [@fifo_3]([] [])
    aie.objectfifo.link [@fifo_4] -> [@fifo_5]([] [])
    %buffer_0_3 = aie.buffer(%tile_0_3) : memref<i32> 
    %buffer_0_3_0 = aie.buffer(%tile_0_3) : memref<16xi32> 
    %buffer_0_2 = aie.buffer(%tile_0_2) : memref<16xi32> 
    %buffer_0_2_1 = aie.buffer(%tile_0_2) : memref<i32> 
    %buffer_0_2_2 = aie.buffer(%tile_0_2) : memref<16xi32> 
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        affine.store %c1_i32, %buffer_0_3[] : memref<i32>
        affine.for %arg1 = 0 to 16 {
          %6 = affine.load %buffer_0_3[] : memref<i32>
          affine.store %6, %buffer_0_3_0[%arg1] : memref<16xi32>
        }
        ...
        func.call @add_i32_vector(%1, %buffer_0_3_0, %3) {lib = "add_i32_vector"} : (memref<16xi32>, memref<16xi32>, memref<16xi32>) -> ()
        %4 = aie.objectfifo.acquire @pipe(Produce, 1) : !aie.objectfifosubview<memref<16xi32>>
        %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<16xi32>> -> memref<16xi32>
        memref.copy %1, %5 : memref<16xi32> to memref<16xi32>
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<16xi32>> -> memref<16xi32>
        affine.store %c1_i32, %buffer_0_2_1[] : memref<i32>
        affine.for %arg1 = 0 to 16 {
          %4 = affine.load %buffer_0_2_1[] : memref<i32>
          affine.store %4, %buffer_0_2_2[%arg1] : memref<16xi32>
        }
        %2 = aie.objectfifo.acquire @fifo_4(Produce, 1) : !aie.objectfifosubview<memref<16xi32>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<16xi32>> -> memref<16xi32>
        func.call @add_i32_vector(%1, %buffer_0_2_2, %3) {lib = "add_i32_vector"} : (memref<16xi32>, memref<16xi32>, memref<16xi32>) -> ()
