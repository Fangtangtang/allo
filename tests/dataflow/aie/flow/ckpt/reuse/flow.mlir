module {
  aie.device(npu1_4col) {
    ...
    ^bb5:  // pred: ^bb3
      ...
      func.call @add_i32_vector(%pipe_buff_0, %_anonymous4, %fifo_4_buff_0) {lib = "add_i32_vector"} : (memref<16xi32>, memref<16xi32>, memref<16xi32>) -> ()
    ...
    ^bb8:  // pred: ^bb6
      aie.use_lock(%fifo_4_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @add_i32_vector(%pipe_buff_1, %_anonymous4, %fifo_4_buff_1) {lib = "add_i32_vector"} : (memref<16xi32>, memref<16xi32>, memref<16xi32>) -> ()
      aie.use_lock(%pipe_prod_lock_0, Release, 1)
      aie.use_lock(%fifo_4_cons_lock_0, Release, 1)
      %10 = arith.addi %0, %c2 : index
      cf.br ^bb1(%10 : index)
