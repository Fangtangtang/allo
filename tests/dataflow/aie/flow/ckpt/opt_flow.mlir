module {
  aie.device(npu1_4col) {
    ...
    ^bb5:  // pred: ^bb3
      ...
      func.call @add_i32_vector(%fifo_0_cons_buff_0, %_anonymous2, %fifo_2_buff_0) {lib = "add_i32_vector"} : (memref<16xi32>, memref<16xi32>, memref<16xi32>) -> ()
    ...
    ^bb8:  // pred: ^bb6
      aie.use_lock(%fifo_0_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%fifo_2_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @add_i32_vector(%fifo_0_cons_buff_1, %_anonymous2, %fifo_2_buff_1) {lib = "add_i32_vector"} : (memref<16xi32>, memref<16xi32>, memref<16xi32>) -> ()
      aie.use_lock(%fifo_0_cons_prod_lock_0, Release, 1)
      aie.use_lock(%fifo_2_cons_lock_0, Release, 1)
