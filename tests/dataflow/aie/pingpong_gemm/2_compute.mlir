module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @out_mem_C_00(%tile_comp_gemm_1_0_0, {%tile_mem0}, 2 : i32) : !aie.objectfifo<memref<16x16xi16>>
    aie.objectfifo.link [@out_mem_C_00] -> [@out_shim_C]([0] [])
    aie.objectfifo @pipe_0_0_0(%tile_comp_gemm_0_0_0, {%tile_comp_gemm_1_0_0}, 2 : i32) : !aie.objectfifo<memref<16x16xi16>>
    ...
    %core_0_3_tile_comp_gemm_1_0_0 = aie.core(%tile_comp_gemm_1_0_0) {
      ...
      scf.for %arg0 = %global_c0 to %c9223372036854775807 step %global_c1 {
        ...
        scf.for %arg4 = %global_c0 to %c16 step %global_c1 {
          scf.for %arg5 = %global_c0 to %c16 step %global_c1 {
            memref.store %c0_i16, %tile_comp_gemm_1_0_0_buf0[%arg4, %arg5] : memref<16x16xi16>
          }
        }
        func.call @matmul_scalar_i16_i16(%local0, %local1, %tile_comp_gemm_1_0_0_buf0) : (memref<16x16xi16>, memref<16x16xi16>, memref<16x16xi16>) -> ()
        ...
        scf.for %arg4 = %global_c0 to %c16 step %global_c1 {
          scf.for %arg5 = %global_c0 to %c16 step %global_c1 {
            %1 = memref.load %tile_comp_gemm_1_0_0_buf0[%arg4, %arg5] : memref<16x16xi16>
            %2 = memref.load %local_pipe_0_0_0[%arg4, %arg5] : memref<16x16xi16>
