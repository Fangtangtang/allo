...
int main(int argc, char** argv) {
    ...
    std::vector<uint8_t>  source_in0(64);
    ifile0.read(reinterpret_cast<char*>(source_in0.data()), 64);
    ...
    std::vector<uint8_t>  source_in1(64);
    ifile1.read(reinterpret_cast<char*>(source_in1.data()), 64);
    ...
    OCL_CHECK(err, cl::Buffer buffer_in0(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, 64, source_in0.data(), &err));
    OCL_CHECK(err, cl::Buffer buffer_in1(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, 64, source_in1.data(), &err));
    ...
    ofile.write(reinterpret_cast<const char*>(source_in1.data()), 64);
    ofile.close();
