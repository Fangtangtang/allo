...
COMMON_REPO ?= $(shell bash -c 'export MK_PATH=$(MK_PATH); echo $${MK_PATH%tests/dataflow/tpu/*}')
...
ifeq ($(TARGET),$(filter $(TARGET),sw_emu hw_emu))
	...
	$(ECHO) '$(EXECUTABLE) top.xclbin' >> run_app.sh
...
README.rst: description.json
	$(XF_PROJ_ROOT)/allo/harness/readme_gen/readme_gen.py description.json
